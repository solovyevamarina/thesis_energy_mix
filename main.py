...
from modelling_process.function_evaluate_models import combined_forecasting_function
...
country_configs = {
    ...
    'PL': {
        ...
        'labels': (
        'Βιομάζα', 'Λινίτης', 'Άνθρακας', 'Ανθρακαέριο', 'Φυσικό Αέριο', 'Πετρέλαιο', 'Φωτοβολταϊκά', 'Αιολικά',
        'Ύδροηλεκτρικά'),
...
for country, timezone in zip(countries, time_zones):
    ...
    combined_results, error_summary = combined_forecasting_function(all_datasets, start_time, end_time, country, country_configs)
#
#
# country = 'GR'
