...
def generate_descriptive_plots(a_dataset, country, s_time, e_time, country_configs):
    ...
    country_data = a_dataset[file_name].copy()

    # 1. Energy Mix Pie Chart
    try:
        generate_energy_mix_pie_chart(country_data, country, s_time, e_time, country_configs)
    ...
    try:
        calculate_yearly_energy_percentages(country_data, country, s_time, e_time, country_configs)
    ...
    try:
        generate_energy_stack_plot(country_data, country, s_time, e_time, country_configs)
    ...
    try:
        generate_timeline_plot(country_data, country, s_time, e_time, country_configs)
    ...
    try:
        generate_price_timeline_plot(country_data, country, s_time, e_time, country_configs)
